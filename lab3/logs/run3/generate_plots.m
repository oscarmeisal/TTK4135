...
grid;
saveas(travelFigHandle, 'lab3_run3_travel.png');
...
legend('Actual', 'Reference');
grid;
saveas(travelRateFigHandle, 'lab3_run3_travelRate.png');
...
legend('Actual', 'Reference');
grid;
saveas(pitchFigHandle, 'lab3_run3_pitch.png');
...
legend('Actual', 'Reference');
grid;
saveas(pitchRateFigHandle, 'lab3_run3_pitchRate.png');
...
legend('Actual', 'Reference');
grid;
saveas(elevationFigHandle, 'lab3_run3_elevation.png');
...
legend('Actual'); %, 'Reference');
grid;
saveas(elevationRateFigHandle, 'lab3_run3_elevationRate.png');
