...
grid;
saveas(travelFigHandle, 'lab3_run1_travel.png');
...
grid;
saveas(travelRateFigHandle, 'lab3_run1_travelRate.png');
...
legend('Actual', 'Reference');
grid;
saveas(pitchFigHandle, 'lab3_run1_pitch.png');
...
legend('Actual', 'Reference');
grid;
saveas(pitchRateFigHandle, 'lab3_run1_pitchRate.png');
...
legend('Actual', 'Reference', 'Location', 'SouthEast');
grid;
saveas(elevationFigHandle, 'lab3_run1_elevation.png');
...
legend('Actual'); %, 'Reference');
grid;
saveas(elevationRateFigHandle, 'lab3_run1_elevationRate.png');
